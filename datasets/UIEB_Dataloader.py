...
class TrainData(data.Dataset):
    def __init__(self, crop_size, train_data_dir, only_h_flip=False):
        super().__init__()
        train_list_haze = '/home/jxy/projects_dir/datasets/UIEB_new/LIST_full_800.TXT'
...
class ValData(data.Dataset):
    def __init__(self, crop_size_H, crop_size_W, val_data_dir, flag=True):
        ...
        val_list_haze = '/home/jxy/projects_dir/datasets/UIEB_new/LIST_full_800.TXT'
...
class TestData(data.Dataset):
    def __init__(self, local_size, val_data_dir, flag=True):
        ...
        val_list_haze = '/home/jxy/projects_dir/datasets/UIEB_new/LIST_full_test_90.TXT'
