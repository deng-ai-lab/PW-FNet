...
class TrainData(data.Dataset):
    ...
    def get_images(self, index):
        ...
        weight_map = pixel_weight(H, W, 256, 4)
        weight_map = weight_map[:, :, None]
        [rain_img, gt_img, weight_map] = augment([rain_img, gt_img, weight_map], size=self.crop_size, edge_decay=0.,
        ...
        return {'source': rain, 'target': gt, 'filename': rain_name, 'weight_map': weight_map}
