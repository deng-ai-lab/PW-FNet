...
class TrainData_for_SPA(data.Dataset):
    def __init__(self, crop_size, train_data_dir, only_h_flip=False):
        super().__init__()
        train_list_rain = '/home/jxy/projects_dir/datasets/SPAdataset/train/rain/LIST.TXT'
...
class TestData(data.Dataset):
    def __init__(self, local_size, val_data_dir, flag=True, testset="Rain100H"):
        ...
        # val_list_rain = '/home/jxy/projects_dir/datasets/SOTS/outdoor/hazylist.txt'
...
class TestData_for_Internet(data.Dataset):
    def __init__(self, val_data_dir, flag=True):
        ...
        # val_list_rain = "/home/jxy/projects_dir/datasets/Real_Internet/LIST.TXT"
        val_list_rain = "/home/jxy/projects_dir/datasets/RE-RAIN/LIST.TXT"
