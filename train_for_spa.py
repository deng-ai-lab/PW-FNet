...
from datasets.spa_dataloader import TrainData_SPA, TestData_SPA
from numpy import *
...
parser.add_argument('--model', default='PW_FNet_6446', type=str, help='model name')
...
if __name__ == '__main__':
    ...
    # network.load_state_dict(torch.load('/home/jxy/projects_dir/PW-FNet/saved_models/rain/Backbone_mimo_iccv_SPA_6446_best.pth')['state_dict'])
    ...
    train_dir = '/home/jxy/projects_dir/datasets/SPA'
    test_dir = '/home/jxy/projects_dir/datasets/SPA'
    train_dataset = TrainData_SPA(256, train_dir)
    ...
    test_dataset = TestData_SPA(8, test_dir)
    ...
    if not os.path.exists(os.path.join(save_dir, args.model + test_str + '.pth')):
        ...
        for epoch in tqdm(range(setting['epochs'] + 1)):
            ...
            if epoch % setting['eval_freq'] == 0:
                ...
                avg_psnr, avg_ssim, avg_psnr_1, avg_ssim_1, avg_psnr_2, avg_ssim_2, avg_psnr_3, avg_ssim_3, avg_psnr_4, avg_ssim_4 = valid(
                    test_loader, network)
                print(avg_psnr, avg_ssim, avg_psnr_1, avg_ssim_1, avg_psnr_2, avg_ssim_2, avg_psnr_3, avg_ssim_3,
                      avg_psnr_4, avg_ssim_4)
